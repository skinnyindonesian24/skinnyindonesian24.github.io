...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_webfontloader__ = __webpack_require__("01M/");
...
var app = {
  ...
  webFontLoader: function webFontLoader() {
  ...
  landing: function landing() {
    if (__WEBPACK_IMPORTED_MODULE_0_jquery___default()('body.page--home').length) {
      __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.player').YTPlayer();
      ...
      //   '.data-clipboard',
      // ).dataset.clipboardText = currentPageUrl;
